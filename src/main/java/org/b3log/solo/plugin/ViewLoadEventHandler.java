...
import org.b3log.solo.event.AbstractEventListener;
...
public final class ViewLoadEventHandler extends AbstractEventListener<ViewLoadEventData> {
     ...
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(org.b3log.latke.plugin.ViewLoadEventHandler.class);
    ...
    public void action(final Event<ViewLoadEventData> event) {
        ...
        final org.b3log.latke.plugin.PluginManager pluginManager = BeanManager.getInstance().getReference(PluginManager.class);
