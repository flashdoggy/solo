...
public class SkinMgmtService {
    ...
    public void updateSkin(final JSONObject skin) throws ServiceException {
        ...
        try {
            ...
            final JSONObject mobileSkinDirNameOpt = optionRepository.get("mobileSkinDirName");
            mobileSkinDirNameOpt.put(Option.OPTION_VALUE, skin.optString("mobileSkinDirName"));
            optionRepository.update("mobileSkinDirName", mobileSkinDirNameOpt);
